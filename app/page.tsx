      ...
      <div className="grid grid-cols-1 lg:grid-cols-[400px_1fr] gap-8">
        ...
        <div className="space-y-8">
          ...
          <div className="flex items-center gap-4">
            <Image src="https://media.licdxdn.com/dms/image/v2/D4D03AQGHWE1pcS6Yyg/profile-displayphoto-shrink_200_200/profile-displayphoto-shrink_200_200/0/1673967642447?e=1758153600&v=beta&t=KeA7Dk2bv0cn0bp7XfRxLAgwF0hJgVSBTRqFVhGE5X8" alt="Profile" width={150} height={150} className="rounded-full" />
            <div>
